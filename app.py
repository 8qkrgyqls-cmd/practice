...
# ══════════════════════════════════════════════════════════════
# ▼ 파일2에서 추가: 정책 비교 지도에 필요한 상수·데이터·함수
# ══════════════════════════════════════════════════════════════
...
POLICIES = [
    ...
    },
    {
        ...
        "detail": "옥상 녹화·도시 숲·바람길 조성으로 서울 열섬 완화",
...
# ═══════════════════════════════════════════════════════════════
# TAB 6 : 수질 정책 (파일1 원본 + 파일2 지도 섹션 추가)
# ═══════════════════════════════════════════════════════════════
with tab6:
    ...
    policies_detail = [
        {
            ...
            "why": "한강으로 유입되는 하수처리수에는 질소·인 등 영양염류가 포함됩니다. 이들이 과다하면 <b>조류(藻類) 대발생(녹조)</b>을 유발하고, 조류 사체가 분해될 때 막대한 산소를 소비해 DO를 급락시킵니다. 2020년 6월 DO 최솟값 2.1 mg/L의 주요 원인 중 하나입니다.",
            "what": "하수처리장에 <b>고도처리 공정</b>(A²O, MBR)을 도입해 방류수 총인 농도를 0.2 mg/L 이하로 낮춥니다. 서울시는 2030년까지 중랑·탄천 처리장 고도화를 완료하는 계획을 추진 중입니다.",
            "effect": "총인 50% 감소 시 여름 조류 발생량 30–40% 억제 효과가 보고됩니다. DO 여름 최솟값을 약 <b>+1.0–1.5 mg/L</b> 개선 가능합니다."
        },
        {
            "color": "green", "num": "2",
            "title": "비점오염원 관리 — 초기 우수(初期雨水) 처리",
            "why": "도시 강우 시 도로·주차장·공사장에서 씻겨 내려오는 <b>초기 강우 유출수</b>는 오염 농도가 하수와 맞먹습니다. 이 비점오염이 여름 장마철 한강 DO를 2차 급락시키는 원인입니다.",
            "what": "강변 도로에 <b>초기 우수 저류조</b>를 설치하고, 투수성 포장재 확대, 빗물정원(Rain Garden) 조성으로 오염된 초기 우수가 직접 한강에 유입되지 않도록 합니다.",
            "effect": "강우 후 DO 단기 급락 폭을 <b>30–50% 완충</b>할 수 있습니다. 특히 선유 지점(하류·퇴적물 많음)의 여름 최솟값 개선에 효과적입니다."
        },
        {
            "color": "orange", "num": "3",
            "title": "한강 인공 산소 공급 — 폭기(曝氣) 시설 운영",
            "why": "여름 고수온기(수온 26°C 이상)에는 물리적으로 DO 포화 농도 자체가 낮아집니다. 생물학적 방법만으로는 즉각적인 대응이 불가능하며, <b>물고기 집단 폐사</b> 등 생태 재난이 발생할 수 있습니다.",
            "what": "한강 바닥에 <b>산기관(Air Diffuser)</b>을 설치하거나 수중 교반기(Aerator)를 가동해 물에 직접 공기를 불어 넣습니다. 서울시는 이미 일부 구간에서 폭기 선박을 운영 중입니다.",
            "effect": "폭기 시 해당 구간 DO를 단기간에 <b>2–4 mg/L</b> 높일 수 있습니다. 특히 도심 구간(노량진·선유)의 긴급 대응 수단으로 유효합니다."
        },
        {
            "color": "purple", "num": "4",
            "title": "한강 생태습지·수변완충구역 확대",
            "why": "콘크리트로 직선화된 하안은 자정(自淨) 능력이 거의 없습니다. 자연 하안에 비해 유기물 정화 속도가 <b>3–5배 느리며</b>, 수온도 더 빠르게 오릅니다.",
            "what": "한강변에 <b>갈대·부들 등 정수식물</b> 군락을 복원하고 수변 완충 녹지대(최소 30m)를 지정합니다. 이미 조성된 난지·여의도 생태공원을 추가 확대합니다.",
            "effect": "수변 습지는 질소를 연간 최대 <b>500 kg/ha</b> 제거할 수 있습니다. 수온을 1–2°C 낮추는 냉각 효과도 있어 DO 포화도 유지에 기여합니다."
        },
        {
            "color": "teal", "num": "5",
            "title": "수질 실시간 모니터링 고도화 및 조기경보",
            "why": "2020년 선유 8월 데이터 결측(58%)이 보여주듯, 현재 측정망은 극단적 수질 악화 상황에서 오히려 데이터 공백이 생깁니다. 선제적 대응을 위해서는 <b>정밀하고 끊김 없는 측정</b>이 필수입니다.",
            "what": "AI 기반 수질 예측 모델과 IoT 실시간 센서망을 결합해 DO·pH·수온·조류 농도를 10분 단위로 수집하고, 위험 기준 접근 시 자동 경보 발령 체계를 구축합니다.",
            "effect": "DO 5 mg/L 하회 <b>6–12시간 전 예측</b>이 가능해져 폭기 선박 출동, 취수 조정 등 선제 조치 시간을 확보할 수 있습니다."
        },
        {
            "color": "red", "num": "6",
            "title": "기후변화 대응 — 도시 열섬 완화 및 탄소 감축",
            "why": "한강 수질의 가장 큰 장기 위협은 <b>수온 상승</b>입니다. 도시 열섬 효과로 서울 한강 수온은 전국 평균보다 빠르게 오르고 있으며, 수온 1°C 상승은 DO 포화 농도를 약 0.2 mg/L 낮춥니다.",
            "what": "건물 옥상 녹화, 도시 숲 확대, 바람길 조성으로 도시 열섬을 완화하고 탄소 감축을 통해 기온 상승 자체를 억제합니다. 한강 수온 모니터링을 기후 정책 지표로 공식 채택합니다.",
            "effect": "도시 열섬 1°C 완화 시 여름 한강 수온 <b>0.5–0.8°C 감소</b>, DO 연중 최솟값 <b>+0.1–0.16 mg/L</b> 개선 효과가 기대됩니다. 장기적으로는 SSP5-8.5 시나리오를 SSP2-4.5 수준으로 완화하는 핵심 수단입니다."
        },
    ]

    for p in policies_detail:
        c = p['color']
        accent = {'blue':'#2563eb','green':'#22c55e','orange':'#f97316',
                  'purple':'#a855f7','teal':'#0891b2','red':'#ef4444'}[c]
        st.markdown(f"""
        <div class="policy-card {c}">
          ...
          <div class="policy-body">
            ...
            <div class="policy-sub" style="margin-top:10px; border-left:3px solid {accent};">
    ...
    # ══════════════════════════════════════════════════════════
    # ▼ 파일2에서 추가: 정책 실행 전 vs 후 DO 수질 지도 비교
    # ══════════════════════════════════════════════════════════
    st.markdown('<div class="sec-hd">🗺️ 정책 실행 전 vs 후 — DO 수질 지도 비교</div>',
                unsafe_allow_html=True)
    ...
    with sg1:
        st.metric("노량진 DO 변화", f"{after_do_nry:.2f} mg/L", delta=f"+{imp_nry:.2f} mg/L")
        st.caption(f"등급 변화: {do_grade_label(base_do_nry)} → {do_grade_label(after_do_nry)}")
    with sg2:
        st.metric("선유 DO 변화", f"{after_do_syu:.2f} mg/L", delta=f"+{imp_syu:.2f} mg/L")
